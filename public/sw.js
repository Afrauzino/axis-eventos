...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: d.body || '',
    badge: '/axis-push-badge.png', // A branco em fundo transparente (silhueta da barra de status)
    icon: '/axis-push-icon.png',   // logo AXIS (quadrado escuro) no corpo da notificação
    tag: d.tag || undefined,
    renotify: !!d.tag,
    data: { url: d.url || '/' },
  }
