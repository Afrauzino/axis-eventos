...
insert into public.menu_config (key, label, icon, emoji, rota, parent_id, ordem, visivel, roles) values
  ...
  ('menu_equipes',         'Equipes & Escalas', 'shield',          '🛡️', null,               null, 14, true, '{}'),
  ('menu_teatro',          'Teatro',            'theater_comedy',  '🎭', null,               null, 15, true, '{}'),
  ('menu_evento',          'Evento',            'event',           '📍', null,               null, 16, true, '{}'),
  ('menu_saude',           'Saúde',             'medical_services','⛑️', null,               null, 17, true, '{}'),
  ('menu_financeiro',      'Financeiro',        'account_balance_wallet','💰', null,          null, 18, true, '{}'),
  ('menu_admin',           'Administração',     'admin_panel_settings',  '⚙️', null,          null, 19, true, '{}');
