...
export const NAV_GROUPS: Record<string, NavSub[]> = {
  ...
  saude:      [{ label:'Atendimentos', rota:'/saude' }, { label:'Fichas Médicas', rota:'/saude/ficha' }, { label:'Medicamentos', rota:'/saude/medicamentos' }],
  financeiro: [{ label:'Pagamentos', rota:'/financeiro' }, { label:'Doações', rota:'/doacoes' }],
  admin:      [{ label:'Usuários', rota:'/admin' }, { label:'Permissões', rota:'/admin/permissoes' }, { label:'Menus', rota:'/admin/menus' }, { label:'Saúde do Sistema', rota:'/admin/saude-sistema' }, { label:'Relatórios', rota:'/relatorios' }],
}
